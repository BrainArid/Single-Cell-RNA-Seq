...
Using the parameters described above, our workflow produced 21 modules for the single-cell data and 48 modules for the population data set. A breakdown of these modules labeled with their most significant biological process ontology, cellular component ontology, and molecular function ontology is shown for the single-cell data in fig. \ref{fig:57872Clusts} and for the population data in fig. \ref{fig:48865Clusts}. 
